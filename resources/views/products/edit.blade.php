    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Product Information: {{ $product->sku }}</h5>
            </div>
            <div class="card-body">
                c
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    name="product_name" id="product_name" value="{{ old('product_name', $product->name) }}"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01"
                                    ...
                                    id="price" value="{{ old('price', $product->price) }}" min="0" required>
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number"
                                    class="form-control form-control-sm @error('stock') is-invalid @enderror" name="stock"
                                    id="stock" value="{{ old('stock', $product->stock) }}" min="1" required>
                                @error('stock')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <img id="image-preview" class="image-preview"
                                    src="{{ asset('assets/images/products/' . $product->image) }}" alt="Image Preview"
                                    style="display: block;">
                                @error('image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
...
@section('scripts')
    <script>
        ...
        document.getElementById('product-form').addEventListener('submit', function (e) {
            ...
            if (!product_name.value || !category_id.value || !description.value || !price.value || !stock.value) {
