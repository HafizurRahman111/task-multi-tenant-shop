...
@section('content')
                ...
                <tbody>
                    @foreach ($items as $item)
                        <tr>
                            ...
                            <td data-label="Image">
                                <img src="{{ $item->image ? asset('/assets/images/products/' . $item->image) : asset('assets/images/default/no-image-available.jpg') }}"
                                    alt="{{ $item->name }}" class="img-fluid zoom-image"
    ...
    <!-- Zoom Image Modal -->
    <div class="modal" id="zoomModal" tabindex="-1" aria-labelledby="zoomModalLabel" aria-hidden="true">
